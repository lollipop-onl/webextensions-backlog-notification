  ...
  return (
    <div className="px-4 pt-10 pb-6">
      <div className="flex flex-col justify-center">
        ...
        <button className="inline-flex items-center justify-center px-6 py-2 mb-4 text-sm text-white transition-colors rounded-md bg-backlog hover:bg-green-500" onClick={openOptionPage}>拡張機能の設定を開く</button>
